...
const endpoint = 'https://v2.jokeapi.dev/joke/Any?contains=dog&safe-mode&type=single';

async function loadJoke() {
    const previous = sessionStorage.getItem('dog-joke');
    ...
    try {
        ...
        sessionStorage.setItem('dog-joke', joke);
        message.textContent = '';
